...
import { Sparkles, User, Lock, Shield } from 'lucide-react';
        ...
        <div className="text-center">
          ...
          >
            <div className="relative">
              <div className="absolute inset-0 bg-gradient-to-r from-tokyo-magenta to-tokyo-purple rounded-3xl blur-2xl opacity-40 animate-pulse-soft"></div>
              <div className="relative bg-gradient-to-r from-tokyo-magenta to-tokyo-purple p-4 rounded-3xl">
          ...
          >
            ...
            <span className="font-semibold text-tokyo-fg">smart reminders</span>
          </motion.p>
        ...
        >
          <form className="space-y-6" onSubmit={handleSubmit}>
            <div className="space-y-5">
              ...
              <div>
                <label htmlFor="confirmPassword" className="block text-sm font-medium text-tokyo-fg mb-2">
                  Confirm Password
                </label>
                <div className="relative">
                  <div className="absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none">
                    <Shield size={18} className="text-tokyo-comment" />
                  </div>
                  <input
                    id="confirmPassword"
